...
StunMessageReturn stun_message_find_xor_addr_with_offset (const StunMessage *msg,
    StunAttribute type, struct sockaddr_storage *addr, socklen_t *addrlen,
    size_t offset, size_t *next_attr_offset);
...
void stun_message_dump(const StunMessage *msg);
